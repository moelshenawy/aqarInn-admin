...
export default function InvestmentOpportunityAddPage() {
  ...
  return (
    <div className="pb-8 text-right" dir="rtl">
      <form
      ...
      >
        <header className="mb-10 space-y-[19px]">
          ...
          >
            <span className="text-[#ac9063]">إضافة فرصة استثمارية</span>
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-[784px] text-lg leading-7 font-medium text-[#717680] sm:me-auto">
              يمكنك إضافة فرصة استثمارية جديدة من خلال تعبئة البيانات المطلوبة،
              ثم حفظها ليتم تسجيلها في النظام وإتاحتها للمستخدمين المصرح لهم.
            </p>
          </div>
        </header>
