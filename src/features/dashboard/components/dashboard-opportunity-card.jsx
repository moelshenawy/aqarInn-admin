...
export function DashboardOpportunityCard({
  ...
  return (
    <article className="overflow-hidden rounded-xl border border-[color:var(--dashboard-border)] bg-[color:var(--dashboard-bg)] shadow-[var(--dashboard-shadow)]">
      <div className="relative h-[131px] overflow-hidden">
        <img src={image} alt={title} className="size-full object-cover" />
        <div
          className="absolute inset-0 opacity-10 mix-blend-soft-light"
          style={{ backgroundImage: `url(${opportunityOverlay})`, backgroundSize: 'cover' }}
        />
